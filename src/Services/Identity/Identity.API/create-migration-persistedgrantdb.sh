...
if [ $# -ne 2 ]; then
  echo "Usage: create-migration-persistedgrantdb.sh <MigrationName> <Command>"
  exit 1
fi
...
MigrationsDirectory="Data/Persisted/Migrations"
DbContextName="ApplicationPersistedGrantDbContext"
